...
import com.example.shopify.ui.bottom_bar.cart.cart.view.componenet.cart_item_card.CartItemCard
...
import com.example.shopify.ui.bottom_bar.cart.cart.view.componenet.coupon.CartCouponCard
...
import com.example.shopify.ui.bottom_bar.cart.cart.view.componenet.footer.CartFooter
import com.example.shopify.ui.bottom_bar.cart.cart.view.componenet.header.CartHeader
            ...
            LazyColumn(
                ...
                itemsIndexed(cart.lines) { index, cartItem ->
                    CartItemCard(
                        ...
                        onClick = {
                            navigateTo("${com.example.shopify.ui.product_details.ProductDetailsGraph.PRODUCT_DETAILS}/${cartItem.cartProduct.id.encodeProductId()}")
                        }
                    )
                }
